...
const I18n = (() => {
  ...
  const STRINGS = {
    ...
    pt: {
      ...
      character_name_hint: 'Digite o nome que será usado nas cartas e falas.',
      ...
      character_saved: 'Personagem criada. A correspondência será a próxima etapa.',
    ...
    en: {
      ...
      character_name_hint: 'Enter the name that will be used in letters and dialogue.',
      ...
      character_saved: 'Character created. The correspondence will be the next step.',
...
btn_story:        'Történet',
      ...
      character_name_hint: 'Írd be a nevet, amely a levelekben és a párbeszédekben szerepel majd.',
      ...
      character_saved: 'A karakter létrejött. A levelezés lesz a következő lépés.',
